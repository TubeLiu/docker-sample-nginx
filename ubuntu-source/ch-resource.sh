...
echo "deb http://mirrors.aliyun.com/ubuntu/ $RELEASE main restricted universe multiverse
...
deb-src http://mirrors.aliyun.com/ubuntu/ $RELEASE-backports main restricted universe multiverse" > $APT_DIR/sources.list
